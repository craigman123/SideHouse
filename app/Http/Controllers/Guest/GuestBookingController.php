...
class GuestBookingController extends Controller
{
    ...
    // "Find Your Booking" lookup (search + OTP) now lives in
    // GuestBookingSearchController — kept separate since it's an
    // unauthenticated, email-identity-facing flow with its own
    // rate-limit/cache concerns, distinct from the booking-creation flow
